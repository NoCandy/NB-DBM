...
DBM_ANEETHERON_OPTION_YELLINFERNAL		= "Announce Infernals in say";
DBM_ANEETHERON_OPTION_INFERNALSOUND		= "Plays sound when you are target of Inferno";
DBM_ANEETHERON_OPTION_INFERNALICON		= "Set icon on Inferno target";
...
DBM_ANETHERON_SPECWARN_INFERNO			= "Inferno on you!";
DBM_ANETHERON_YELL_INFERNO				= "Inferno on me! Run away from me!";
