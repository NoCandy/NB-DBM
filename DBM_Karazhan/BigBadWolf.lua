...
BBW.Version			= "1.1";
BBW.Author			= "NB-Bodil"; -- Original by Tandanu
...
BBW:AddOption("FearWarn", false, DBM_BBW_OPTION_1);
BBW:AddOption("Whisper", false, DBM_BBW_OPTION_2);
...
function BBW:OnSync(target)
	if target then
		...
		self:StartStatusBarTimer(60, "Next Red Riding Hood", "Interface\\Icons\\INV_Helmet_28");
		...
		self:ScheduleSelf(55, "RRHSoonWarn");
	end
end
