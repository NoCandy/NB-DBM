...
Curator.Version			= "1.1";
Curator.Author			= "NB-Bodil"; -- Original by Tandanu
...
function Curator:OnCombatStart()
	self:StartStatusBarTimer(98, "Next Evocation", "Interface\\Icons\\Spell_Nature_Purge");
	self:ScheduleSelf(93, "EvoWarn", "soon");
	self:ScheduleAnnounce(38, DBM_CURA_EVO_1MIN, 1)
...
function Curator:OnEvent(event, arg1)
	if event == "CHAT_MSG_MONSTER_YELL" then
		if arg1 == DBM_CURA_YELL_OOM then
			self:StartStatusBarTimer(111, "Next Evocation", "Interface\\Icons\\Spell_Nature_Purge");
			self:StartStatusBarTimer(20, "Evocation", "Interface\\Icons\\Spell_Nature_Purge");
			self:Announce(DBM_CURA_EVO_NOW, 3);
			self:ScheduleAnnounce(51, DBM_CURA_EVO_1MIN, 1)
