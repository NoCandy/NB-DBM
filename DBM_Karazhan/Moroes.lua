...
Moroes.Version			= "1.1";
Moroes.Author			= "NB-Bodil"; -- Original by Tandanu
Moroes.LastVanish		= 0;
	...
	elseif event == "SPELL_AURA_REMOVED" then		
		if arg1.spellId == 29448 then
			...
			if (GetTime() - self.LastVanish) < 20 then
				self:StartStatusBarTimer(30 - (GetTime() - self.LastVanish), "Vanish", "Interface\\Icons\\Ability_Vanish");
				self:ScheduleSelf(25 - (GetTime() - self.LastVanish), "SoonWarning");
			end
		elseif arg1.spellId == 29425 then
