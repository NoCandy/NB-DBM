...
Netherspite.Version			= "1.2";
Netherspite.Author			= "NB-Bodil"; -- Original by Tandanu
Netherspite.Phase			= 1;
...
--[[	if event == "SPELL_CAST_START" then -- I didnt like this, too spammy for almost no info
	...
	elseif event == "SPELL_CAST_SUCCESS" then  -- Him casting voidzone is not consistent with other bosses voidzones so rewrote
	...
	elseif event == "SPELL_DAMAGE" then
		if arg1.spellId == 46264 and arg1.destName == UnitName("player") then
