...
Nightbane.Version			= "1.3";
Nightbane.Author			= "NB-Bodil"; -- Original by Tandanu
...
function Nightbane:OnEvent(event, arg1)
	if event == "CHAT_MSG_MONSTER_EMOTE" then
		if arg1 == DBM_NB_EMOTE_PULL then
			self:StartStatusBarTimer(64, "Nightbane", "Interface\\Icons\\Ability_Mount_Undeadhorse");
		end
	...
	elseif event == "SPELL_CAST_START" then
		if arg1.spellId == 36922 then -- 3/26 22:16:44.062  SPELL_CAST_START,0xF13000434900162B,"Nightbane",0x10a48,0x0000000000000000,nil,0x80000000,36922,"Bellowing Roar",0x1
			self:StartStatusBarTimer(31.5, "Fear on CD", "Interface\\Icons\\Spell_Shadow_PsychicScream");
	...
	elseif event == "CHAT_MSG_MONSTER_YELL" then
		if arg1 == DBM_NB_YELL_AIR then
			...
			self:ScheduleSelf(45, "DownFIRSTWarn");
			self:ScheduleSelf(55, "DownSECWarn");
			self:StartStatusBarTimer(60, "Air Phase", "Interface\\AddOns\\DBM_API\\Textures\\CryptFiendBurrow");
		--elseif (arg1 == DBM_NB_YELL_GROUND or arg1 == DBM_NB_YELL_GROUND2) and ((GetTime() - self.LastYell) > 45) then -- retail bug
