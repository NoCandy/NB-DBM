...
Aran.Version		= "1.1";
Aran.Author			= "NB-Bodil"; -- Original by Tandanu
...
function Aran:OnEvent(event, arg1)
	if event == "SPELL_CAST_START" then
		...
		elseif arg1.spellId == 29969 then
			self:Announce(DBM_ARAN_BLIZZ_WARN, 2);
			self:StartStatusBarTimer(2, "Blizzard", "Interface\\Icons\\Spell_Frost_IceStorm");
			self:ScheduleSelf(2, "Blizzard");
		end
	elseif event == "CHAT_MSG_MONSTER_YELL" or event == "CHAT_MSG_MONSTER_SAY" then
		...
		if arg1 == DBM_ARAN_YELL_ADDS then
