...
DBM_ATH_PHASE_1			= "***Phase 1***"
DBM_ATH_PHASE_2			= "***Phase 2***"
...
DBM_MOV_OPTION_2		= "Announce Repentance Soon";
...
DBM_TI_OPTION_2			= "Announce sacrifice sooon";
...
DBM_NS_OPTION_4			= "Announce Netherbreath on target";
...
DBM_NS_WARN_BREATH		= "*** Netherbreath on >%s< ***";
...
DBM_PRINCE_YELL_P3		= "I see the subtlety of conception is beyond primitives such as you."--"How can you hope to stand against such overwhelming power?";
...
DBM_PRINCE_WARN_NOVA		= "*** Shadow Nova ***";
