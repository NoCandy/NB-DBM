...
Maulgar.Version			= "1.1";
Maulgar.Author			= "NB-Bodil"; -- Original by Tandanu
...
Maulgar:AddOption("WarnPWS",			false,	DBM_MAULGAR_OPTION_1);
...
function Maulgar:OnCombatStart(delay)
	self:StartStatusBarTimer(31 - delay, "Next Whirlwind", "Interface\\Icons\\Ability_Whirlwind");
