...
Tidewalker.Author		= "NB-Bodil"; -- Original by Tandanu
...
function Tidewalker:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(28 - delay, "Watery Grave", "Interface\\Icons\\Spell_Shadow_DemonBreath");	
...
function Tidewalker:OnEvent(event, arg1)
	...
	elseif event == "CHAT_MSG_RAID_BOSS_EMOTE" then
		if arg1 == DBM_TIDEWALKER_EMOTE_MURLOCS then
			...
			self:StartStatusBarTimer(55, "Murlocs", "Interface\\Icons\\INV_Misc_MonsterHead_02");
			self:UnScheduleSelf("MurlocWarn");
			self:ScheduleSelf(50, "MurlocWarn");
		elseif arg1 == DBM_TIDEWALKER_EMOTE_GRAVE then
			self:StartStatusBarTimer(25, "Watery Grave", "Interface\\Icons\\Spell_Shadow_DemonBreath");
