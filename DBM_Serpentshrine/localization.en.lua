...
DBM_FATHOMLORD_OPTION_SOUND			= "Play sound when Spitfire Totem spawn";
...
DBM_FATHOMLORD_SFTOTEM1_WARN		= "*** SPITFIRE @ Shaman ***";
DBM_FATHOMLORD_SFTOTEM2_WARN		= "*** SPITFIRE @ Fathom-Lord ***";
...
DBM_LEO_WARN_WHIRL_SOON_2			= "*** Whirlwind in 5 sec ***";
DBM_LEO_WARN_WHIRL_FADED			= "*** Whirlwind faded ***";
DBM_LEO_WARN_SHADOW					= "*** Leotheras Split ***";
