...
Solarian.Author		= "NB-Bodil"; -- Original by Tandanu
...
function Solarian:OnSync(msg)
	...
	elseif msg == "Split" then
		...
		if self.Options.WarnPhase then
			...
			self:ScheduleSelf(2, "AgentsNow");
			self:ScheduleSelf(15, "PriestsWarn");
			self:ScheduleSelf(20, "PriestsNow");
			self:ScheduleSelf(65, "SplitWarn");
		end		
		self:StartStatusBarTimer(70, "Split", "Interface\\Icons\\Spell_Holy_SummonLightwell");
		self:StartStatusBarTimer(20.5, "Priests & Solarian", "Interface\\Icons\\Spell_Holy_Renew");
		self:StartStatusBarTimer(2, "Agents", "Interface\\Icons\\Spell_Holy_AuraMastery");
