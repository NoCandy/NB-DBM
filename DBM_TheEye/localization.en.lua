...
DBM_ALAR_WARN_METEOR_SOON				= "*** Meteor in 8 sec ***";
DBM_ALAR_WARN_ENRAGE					= "*** Enrage in %s %s ***";

-- Kael'thas
DBM_KAEL_NAME							= "Kael'thas Sunstrider";
DBM_KAEL_THALA_NAME						= "Thaladred the Darkener";
...
DBM_KAEL_OPTION_THALA_TARGET			= "Announce Thaladred's target";
...
DBM_KAEL_WARN_BARRIER_DOWN				= "*** Barrier down! ***";
...
DBM_KAEL_GRAVITY_END_SOON				= "*** Gravity Lapse ends in 8 sec ***";
